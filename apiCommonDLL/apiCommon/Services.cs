...
namespace apiCommonDLL
{
    ...
    public static class Services
    {
        ...
        public static string BulkUpdateData(DataTable data, string Columns, string tableName, int ApiID)
        {
            string result = "";
            ...
            using (OracleConnection connection = new OracleConnection())
            {
                ...
                using (OracleCommand cmd = new OracleCommand(SQLString, connection))
                {
                    ...
                    try
                    {
                        ...
                        result = "Success, Data Records Updated in table " + tableName + " : " + i + "";
                    ...
                    catch (System.Data.OracleClient.OracleException E)
                    {
                        trans.Rollback();
                        connection.Close();
                        result = "Data Records Update has Failed into table " + tableName + " : " + E.Message + ", API Number: " + ApiID + "";
                        log.Info("Data Records Update has Failed into table " + tableName + " : " + E.Message + ", API Number: " + ApiID + "");
                        #region Creating Log Record After Failure in Inserting all Records
                        DataLogInsert.InsertLog("Error, Records Failed while Updating table " + tableName + " : " + E.Message + "", ApiID, "No");
                        #endregion
                        return result;
                        //return false;
                    }
