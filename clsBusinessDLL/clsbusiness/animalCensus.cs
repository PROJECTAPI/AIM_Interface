...
namespace clsBusinessDLL
{
    ...
    public class animalCensus
    {
        ...
        public static string deactivateCard(int Card_ID, string Message)
        {
            string result;
...
#pragma warning restore CS0168 // The variable 'ex' is declared but never used
        ...
        public static string activateCard(int Card_ID, string Message)
        {
            string result;
           // var connectionString = DbConnection.ConnectionString.GetConnection();
            ...
            try
            {
                ...
                Console.WriteLine("Card Id: " + Card_ID + " Successfully Activated");
                result = "Success";
...
#pragma warning restore CS0168 // The variable 'ex' is declared but never used
        ...
        public static string relocateCard(int Card_ID, string Message)
        {
            string result;
          //  var connectionString = DbConnection.ConnectionString.GetConnection();
            ...
            try
            {
                ...
                Console.WriteLine("Card Id: " + Card_ID + " Successfully Re-Located");
                result = "Success";
